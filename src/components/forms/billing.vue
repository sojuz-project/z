    ...
    >
      <template v-slot="{ mutate, loading }">
        ...
        >
          ...
          <input v-model="first_name" class="has-ultrasmall-font-size" placeholder="Username" required="required" />
          <label class="has-ultrasmall-font-size">
            Last name
          </label>
          <input v-model="last_name" class="has-ultrasmall-font-size" placeholder="Username" required="required" />
          <label class="has-ultrasmall-font-size">
            Email adress
          </label>
          <input v-model="user_email" class="has-ultrasmall-font-size" placeholder="Username" required="required" />
